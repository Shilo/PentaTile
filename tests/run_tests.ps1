...
#   .\tests\run_tests.ps1                     # all tests, headless
#   .\tests\run_tests.ps1 -Verbose            # full output
#   .\tests\run_tests.ps1 -Test paint_test    # one test
#   .\tests\run_tests.ps1 -Windowed           # window opens (no --headless)
#   .\tests\run_tests.ps1 -NoPause            # skip the press-any-key
#   .\tests\run_tests.ps1 -GodotExe <path>    # custom Godot executable
#
...
try {
    ...
    # Project root = one level up from this script (tests/).
