...
## Run headlessly:
##   Godot_v4.6.2-stable_win64_console.exe --headless --path . --script tests/_capture_baseline.gd
##
## Optional layout swap (for capturing non-default-layout baselines, e.g. the WR-07 VERTICAL baseline):
##   ... --script tests/_capture_baseline.gd -- --layout-path=res://addons/penta_tile/demo/penta_layout_four_vertical.tres
