...
| `addons/penta_tile/tests/fallback_routing_test.gd`                             | Composed-canvas test (8 layouts × 1 pattern + 3 PREVIEW-04 sub-tests)                 | VERIFIED   | Exists. 10,338 bytes. Headless run exits 0 with `ALL PASS` (verified by full suite run).                       |
| `addons/penta_tile/tests/run_tests.ps1`                                        | Registry contains `fallback_routing_test` (count 18)                                  | VERIFIED   | Full suite reports `ALL GREEN (18 tests)`.                                                                    |
...
| --------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------- | ------ |
| Full test suite green (18 tests including fallback)       | `pwsh -File addons/penta_tile/tests/run_tests.ps1 -NoPause`                  | `ALL GREEN (18 tests)`          | PASS   |
